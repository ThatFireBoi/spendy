...
const AboutUs = () => {
    return (
        <div className="about-us" id="about-us">
            ...
            <div>
                <a href="https://www.linkedin.com/in/gabrielcastroflores/" class="button-linkedin" >Gabriel's LinkedIn</a>
                <a href="https://www.linkedin.com/in/nataliagrivera/" class="button-linkedin">Natalia's LinkedIn</a>
            </div>
            <div className="github links">
                <a href="https://github.com/ThatFireBoi" class="button-git">Gabriel's GitHub</a>
                <a href="https://github.com/nataliagrivera" class="button-git">Natalia's GitHub</a>
            </div>
        </div>
    );
}
